...
exports.ConectadosFacturaStack = void 0;
...
class ConectadosFacturaStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        [authLambda, billingLambda, stockLambda, paymentsLambda, syncLambda, ocrLambda].forEach(fn => {
            ...
            fn.role.attachInlinePolicy(new iam.Policy(this, `${fn.node.id}Policy`, {
                statements: [
...
exports.ConectadosFacturaStack = ConectadosFacturaStack;
//# sourceMappingURL=aws-cdk-stack.js.map